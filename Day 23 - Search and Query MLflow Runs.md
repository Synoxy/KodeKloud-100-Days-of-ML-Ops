...
4. Navigate to Overview and on bottom right you should see **Add tags**. Add the required tags as asked, for the one with highest f1_score add the key: review-status and value: shortlisted. Same for rejected ones. Refer: [Day 22 - Create and Organize MLflow Experiments](https://github.com/Synoxy/KodeKloud-100-Days-of-MLOps/blob/24454e8ac36bbbb4cc3f2707f3145cbca16a5e1a/Day%2022%20-%20Create%20and%20Organize%20MLflow%20Experiments.md) on how to add tag.
