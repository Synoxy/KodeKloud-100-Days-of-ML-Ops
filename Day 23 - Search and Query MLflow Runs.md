...
4. Navigate to Overview and on bottom right you should see **Add tags**. Add the required tags as asked, for the one with highest f1_score add the key: review-status and value: shortlisted. Same for rejected ones. Refer: [Day 22 - Create and Organize MLflow Experiments](../../Day%2022%20-%20Create%20and%20Organize%20MLflow%20Experiments.md) on how to add tag.
