...
🛠️ **Solution:**
1. Open Mlflow UI and navigate to the model with highest f1-score and register the model as **fraud-detector-v2**, add alias as **champion**.
2. Navigate back to the terminal and run below commands.
```text
